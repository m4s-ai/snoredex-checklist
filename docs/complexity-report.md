...
McCabe estimate: sum 4,250; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1632` | `collectFunctions`           |         49 |
| `scripts/complexity-report.mjs:1022` | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1548` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:394`  | `isSemicolonlessClassMethod` |         35 |
