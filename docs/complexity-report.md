...
McCabe estimate: sum 4,006; mean 5.2; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:1043` | `collectFunctions`         |         44 |
| `src/site/query.ts:31`               | `parseQuery`               |         39 |
| `scripts/complexity-report.mjs:959`  | `findStatementEnd`         |         36 |
