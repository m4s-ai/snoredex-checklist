...
McCabe estimate: sum 4,286; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1760` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1676` | `findStatementEnd`           |         36 |
...
| `scripts/complexity-report.mjs:1415` | `isConditionalTypeQuestion`  |         32 |
