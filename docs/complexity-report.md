...
McCabe estimate: sum 4,315; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1811` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1727` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:401`  | `isSemicolonlessClassMethod` |         35 |
| `scripts/complexity-report.mjs:1464` | `isConditionalTypeQuestion`  |         35 |
