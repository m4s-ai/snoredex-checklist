...
McCabe estimate: sum 4,270; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1693` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1609` | `findStatementEnd`           |         36 |
