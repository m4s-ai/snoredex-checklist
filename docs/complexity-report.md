...
Lines: 13,181.
Function-like nodes: 765.
McCabe estimate: sum 3,975; mean 5.2; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:924` | `collectFunctions`         |         39 |
| `src/site/query.ts:31`              | `parseQuery`               |         39 |
| `scripts/complexity-report.mjs:840` | `findStatementEnd`         |         36 |
