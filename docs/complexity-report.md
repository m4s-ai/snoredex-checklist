...
Lines: 13,354.
Function-like nodes: 825.
McCabe estimate: sum 3,816; mean 4.6; median 2; P90 10; P95 18.
...
| `src/state/backup.ts:316`                 | `writeAuthority`                 |         34 |
| `src/state/backup.ts:543`                 | `<arrow>`                        |         34 |
