...
McCabe estimate: sum 4,255; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1663` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1579` | `findStatementEnd`           |         36 |
