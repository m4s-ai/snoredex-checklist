...
McCabe estimate: sum 4,151; mean 5.3; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1376` | `collectFunctions`           |         48 |
| `scripts/complexity-report.mjs:859`  | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1292` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `src/catalogue/sync.ts:517`          | `parseJournal`               |         34 |
| `scripts/complexity-report.mjs:350`  | `isSemicolonlessClassMethod` |         33 |
