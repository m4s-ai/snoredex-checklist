...
McCabe estimate: sum 4,318; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1815` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1731` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:401`  | `isSemicolonlessClassMethod` |         35 |
| `scripts/complexity-report.mjs:1468` | `isConditionalTypeQuestion`  |         35 |
