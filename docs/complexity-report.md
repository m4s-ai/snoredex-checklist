...
| `scripts/complexity-report.mjs:1803` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1719` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:401`  | `isSemicolonlessClassMethod` |         35 |
| `scripts/complexity-report.mjs:1456` | `isConditionalTypeQuestion`  |         35 |
