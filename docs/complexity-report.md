...
McCabe estimate: sum 4,043; mean 5.2; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:618`  | `findArrowExpressionEnd`   |         47 |
...
| `scripts/complexity-report.mjs:282`  | `isTypedFunctionBody`      |         28 |
