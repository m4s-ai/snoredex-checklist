...
| `scripts/complexity-report.mjs:418` | `findArrowExpressionEnd`       |         47 |
| `scripts/check-artifact.mjs:1311`   | `extractHead`                  |         45 |
| `src/site/query.ts:31`              | `parseQuery`                   |         39 |
| `scripts/complexity-report.mjs:520` | `findStatementEnd`             |         36 |
...
| `scripts/complexity-report.mjs:604` | `collectFunctions`             |         32 |
