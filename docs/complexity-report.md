...
Lines: 14,761.
Function-like nodes: 792.
McCabe estimate: sum 4,306; mean 5.4; median 2; P90 13; P95 23.
Hotspots: 105 functions exceed 10; 48 exceed 20.
...
| `scripts/complexity-report.mjs:1785` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1701` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:401`  | `isSemicolonlessClassMethod` |         35 |
| `scripts/complexity-report.mjs:1438` | `isConditionalTypeQuestion`  |         35 |
