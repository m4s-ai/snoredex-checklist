...
Lines: 13,143.
Function-like nodes: 763.
McCabe estimate: sum 3,967; mean 5.2; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:555` | `findArrowExpressionEnd`   |         47 |
| `scripts/check-artifact.mjs:1311`   | `extractHead`              |         45 |
| `src/site/query.ts:31`              | `parseQuery`               |         39 |
| `scripts/complexity-report.mjs:899` | `collectFunctions`         |         38 |
| `scripts/complexity-report.mjs:815` | `findStatementEnd`         |         36 |
...
| `scripts/complexity-report.mjs:231` | `isTypedFunctionBody`      |         28 |
