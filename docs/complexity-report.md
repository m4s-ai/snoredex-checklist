...
McCabe estimate: sum 3,891; mean 5.1; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:597` | `findStatementEnd`             |         36 |
| `scripts/complexity-report.mjs:681` | `collectFunctions`             |         36 |
