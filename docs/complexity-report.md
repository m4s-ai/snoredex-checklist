...
Lines: 12,938.
Function-like nodes: 998.
McCabe estimate: sum 3,914; mean 3.9; median 2; P90 9; P95 16.
...
| `scripts/complexity-report.mjs:754` | `collectFunctions`              |         38 |
| `scripts/complexity-report.mjs:670` | `findStatementEnd`              |         36 |
