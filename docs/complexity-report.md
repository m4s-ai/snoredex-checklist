...
Lines: 11,194.
Function-like nodes: 708.
McCabe estimate: sum 3,219; mean 4.5; median 2; P90 9; P95 19.
Hotspots: 65 functions exceed 10; 32 exceed 20.
...
| `scripts/check-artifact.mjs:511`  | `extractHead`                  |         45 |
...
| `src/state/backup.ts:520`         | `<arrow>`                      |         26 |
