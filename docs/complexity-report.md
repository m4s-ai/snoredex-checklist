...
Lines: 13,429.
Function-like nodes: 827.
McCabe estimate: sum 3,835; mean 4.6; median 2; P90 10; P95 18.
Hotspots: 76 functions exceed 10; 37 exceed 20.
...
| `src/site/app.ts:1348`                    | `renderResults`                  |         75 |
| `src/state/storage.ts:711`                | `persistPendingNoteDraft`        |         75 |
...
| `src/state/backup.ts:610`                 | `<arrow>`                        |         36 |
| `src/state/storage.ts:1148`               | `setDraftOwnerState`             |         36 |
| `src/catalogue/sync.ts:517`               | `parseJournal`                   |         34 |
| `src/state/backup.ts:373`                 | `writeAuthority`                 |         34 |
| `scripts/check-artifact.mjs:265`          | `stripHtmlComments`              |         32 |
...
| `src/state/browser-reconciliation.ts:121` | `writeAuthority`                 |         28 |
