...
McCabe estimate: sum 3,802; mean 5.1; median 2; P90 12; P95 22.
...
| `scripts/complexity-report.mjs:428` | `findStatementEnd`             |         36 |
...
| `scripts/complexity-report.mjs:512` | `collectFunctions`             |         28 |
