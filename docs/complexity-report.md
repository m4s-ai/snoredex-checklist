...
Lines: 13,104.
Function-like nodes: 761.
McCabe estimate: sum 3,956; mean 5.2; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:538` | `findArrowExpressionEnd`   |         47 |
| `scripts/check-artifact.mjs:1311`   | `extractHead`              |         45 |
| `src/site/query.ts:31`              | `parseQuery`               |         39 |
| `scripts/complexity-report.mjs:873` | `collectFunctions`         |         38 |
| `scripts/complexity-report.mjs:789` | `findStatementEnd`         |         36 |
...
| `scripts/complexity-report.mjs:217` | `isTypedFunctionBody`      |         28 |
