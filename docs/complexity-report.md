...
McCabe estimate: sum 4,260; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1678` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1594` | `findStatementEnd`           |         36 |
