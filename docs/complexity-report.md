...
Lines: 14,334.
Function-like nodes: 788.
McCabe estimate: sum 4,251; mean 5.4; median 2; P90 13; P95 23.
Hotspots: 104 functions exceed 10; 47 exceed 20.
...
| `scripts/complexity-report.mjs:1636` | `collectFunctions`           |         49 |
| `scripts/complexity-report.mjs:1026` | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1552` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:398`  | `isSemicolonlessClassMethod` |         35 |
