...
Lines: 14,179.
Function-like nodes: 785.
McCabe estimate: sum 4,210; mean 5.4; median 2; P90 13; P95 23.
Hotspots: 103 functions exceed 10; 47 exceed 20.
...
| `scripts/complexity-report.mjs:1543` | `collectFunctions`           |         49 |
| `scripts/complexity-report.mjs:934`  | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1459` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:376`  | `isSemicolonlessClassMethod` |         35 |
