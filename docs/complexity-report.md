...
Lines: 14,836.
Function-like nodes: 793.
McCabe estimate: sum 4,322; mean 5.5; median 2; P90 13; P95 23.
Hotspots: 105 functions exceed 10; 49 exceed 20.
...
| `scripts/complexity-report.mjs:1827` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1743` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:401`  | `isSemicolonlessClassMethod` |         35 |
| `scripts/complexity-report.mjs:1480` | `isConditionalTypeQuestion`  |         35 |
