...
McCabe estimate: sum 4,283; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1752` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1668` | `findStatementEnd`           |         36 |
