...
McCabe estimate: sum 4,086; mean 4.8; median 2; P90 10; P95 19.
...
| `src/site/app.ts:1455`                    | `renderResults`                  |         75 |
