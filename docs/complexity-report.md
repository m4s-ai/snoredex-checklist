...
Lines: 13,846.
Function-like nodes: 846.
McCabe estimate: sum 3,956; mean 4.7; median 2; P90 10; P95 18.
...
| `src/state/backup.ts:557`                 | `writeAuthority`                 |         41 |
| `src/site/deployment.ts:38`               | `validatePagesDeployment`        |         40 |
| `src/state/backup.ts:870`                 | `<arrow>`                        |         39 |
