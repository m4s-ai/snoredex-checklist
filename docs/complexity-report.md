...
McCabe estimate: sum 4,082; mean 5.3; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:702`  | `findArrowExpressionEnd`   |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`              |         45 |
| `scripts/complexity-report.mjs:1212` | `collectFunctions`         |         45 |
| `src/site/query.ts:31`               | `parseQuery`               |         39 |
| `scripts/complexity-report.mjs:1128` | `findStatementEnd`         |         36 |
...
| `scripts/complexity-report.mjs:358`  | `isTypedFunctionBody`      |         28 |
