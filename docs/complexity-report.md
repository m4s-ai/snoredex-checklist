...
Lines: 13,787.
Function-like nodes: 775.
McCabe estimate: sum 4,111; mean 5.3; median 2; P90 13; P95 22.
Hotspots: 99 functions exceed 10; 45 exceed 20.
...
| `scripts/complexity-report.mjs:1268` | `collectFunctions`           |         48 |
| `scripts/complexity-report.mjs:751`  | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1184` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `src/catalogue/sync.ts:517`          | `parseJournal`               |         34 |
| `scripts/complexity-report.mjs:243`  | `isSemicolonlessClassMethod` |         33 |
