...
Lines: 12,633.
Function-like nodes: 752.
McCabe estimate: sum 3,849; mean 5.1; median 2; P90 12; P95 22.
...
| `scripts/complexity-report.mjs:400` | `findArrowExpressionEnd`       |         47 |
| `scripts/check-artifact.mjs:1311`   | `extractHead`                  |         45 |
| `src/site/query.ts:31`              | `parseQuery`                   |         39 |
| `scripts/complexity-report.mjs:501` | `findStatementEnd`             |         36 |
...
| `scripts/complexity-report.mjs:585` | `collectFunctions`             |         30 |
