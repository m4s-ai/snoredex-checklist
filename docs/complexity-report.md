...
McCabe estimate: sum 4,253; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1639` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1555` | `findStatementEnd`           |         36 |
