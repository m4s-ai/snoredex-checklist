...
McCabe estimate: sum 4,374; mean 5.5; median 2; P90 14; P95 24.
...
| `scripts/complexity-report.mjs:1931` | `collectFunctions`           |         49 |
| `scripts/complexity-report.mjs:1133` | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `scripts/complexity-report.mjs:36`   | `scan`                       |         43 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1847` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `scripts/complexity-report.mjs:505`  | `isSemicolonlessClassMethod` |         35 |
| `scripts/complexity-report.mjs:1584` | `isConditionalTypeQuestion`  |         35 |
