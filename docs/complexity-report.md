...
Lines: 13,726.
Function-like nodes: 773.
McCabe estimate: sum 4,088; mean 5.3; median 2; P90 13; P95 22.
...
| `scripts/complexity-report.mjs:720`  | `findArrowExpressionEnd`     |         47 |
| `scripts/check-artifact.mjs:1311`    | `extractHead`                |         45 |
| `scripts/complexity-report.mjs:1230` | `collectFunctions`           |         45 |
| `src/site/query.ts:31`               | `parseQuery`                 |         39 |
| `scripts/complexity-report.mjs:1146` | `findStatementEnd`           |         36 |
| `src/state/storage.ts:1142`          | `setDraftOwnerState`         |         36 |
| `src/catalogue/sync.ts:517`          | `parseJournal`               |         34 |
| `scripts/complexity-report.mjs:213`  | `isSemicolonlessClassMethod` |         33 |
