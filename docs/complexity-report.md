...
Lines: 13,935.
Function-like nodes: 857.
McCabe estimate: sum 3,980; mean 4.6; median 2; P90 10; P95 18.
...
| `src/site/app.ts:1401`                    | `renderResults`                  |         75 |
...
| `src/state/backup.ts:560`                 | `writeAuthority`                 |         41 |
| `src/site/deployment.ts:38`               | `validatePagesDeployment`        |         40 |
| `src/state/backup.ts:874`                 | `<arrow>`                        |         40 |
