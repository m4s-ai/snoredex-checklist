...
McCabe estimate: sum 4,257; mean 5.4; median 2; P90 13; P95 23.
...
| `scripts/complexity-report.mjs:1656` | `collectFunctions`           |         49 |
...
| `scripts/complexity-report.mjs:1572` | `findStatementEnd`           |         36 |
