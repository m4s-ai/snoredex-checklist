...
McCabe estimate: sum 3,803; mean 5.1; median 2; P90 12; P95 22.
...
| `scripts/complexity-report.mjs:429` | `findStatementEnd`             |         36 |
...
| `scripts/complexity-report.mjs:513` | `collectFunctions`             |         28 |
